...
const PACKAGE_VERSION = process.env.npm_package_version || "1.14.5";
/**
...
export class BrutalistServer {
    ...
    registerSpecialTools() {
        ...
        this.server.tool("cli_agent_roster", "Know your weapons. Display the available CLI agent critics (Claude Code, Codex, Antigravity/Agy) ready to demolish your work, their capabilities, and how to deploy them for systematic destruction.", {}, async (args) => {
            try {
    ...
    async handleUnifiedRoast(args, extra) {
        ...
        if (args.domain === 'design') {
            const mcpServers = Array.isArray(args.mcp_servers) ? [...args.mcp_servers] : [];
