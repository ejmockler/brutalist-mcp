...
import { resolveServers, listRegisteredServers, writeClaudeMcpConfigSecure, ensurePlaywrightBrowsers, } from '../mcp-registry.js';
/**
...
export class ClaudeAdapter {
    ...
    decode(stdout, _stderr, args, log) {
 ...
 */
function classifyClaudeErrorReason(envelope) {
    if (!envelope)
        return 'unknown';
    const markers = [
